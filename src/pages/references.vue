<main role="main" class="container">
  ...
  <p>
    ...
    format (e.g. for v.2.4.0: <a href="http://www.id3.org/id3v2.4.0-structure.txt">http://www.id3.org/id3v2.4.0-structure</a>)
    and its native frames (e.g. for v.2.4.0: <a href="http://www.id3.org/id3v2.4.0-frames">http://www.id3.org/id3v2.4.0-frames.txt</a>).
